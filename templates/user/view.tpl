...
{*pagesetvar name='javascript' value='modules/Programador/javascript/Programador.js'*}
...
{ /section }
 ...
 <form class="z-form" action="{modurl modname="Programador" type="user" func="view"}" method="post" enctype="application/x-www-form-urlencoded">
...
{foreach from=$programs item=program name=con}
	{assign var=loopProg value=$smarty.foreach.con.iteration}
